...
"""
	In other words, this class describes the node.
	In the basic model, a customer have a demand,
	we may want to store its coordinates, but we probably won't have to in this case.
